...
\restrict IGW4kzfdDHa3ziYVymzXiHRYBd8a184IjIGv99WMihfY9arziuaflgP7VuBPSsE
...
CREATE TABLE public.interactions (
    ...
    discovered_in_query character varying(50),
    discovery_method character varying(50) DEFAULT 'pipeline'::character varying,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    updated_at timestamp without time zone DEFAULT now() NOT NULL,
...
CREATE TABLE public.pathway_interactions (
    ...
    assignment_method character varying(50) DEFAULT 'ai_pipeline'::character varying,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.pathway_parents (
    ...
    relationship_type character varying(30) DEFAULT 'is_a'::character varying NOT NULL,
...
CREATE TABLE public.protein_aliases (
    ...
    source character varying(32) DEFAULT 'curated'::character varying NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);
...
\unrestrict IGW4kzfdDHa3ziYVymzXiHRYBd8a184IjIGv99WMihfY9arziuaflgP7VuBPSsE
