...
\restrict vZqc9htGIoXOj3CJcKLSHINSFZT5qotseNQ42p0eRbLyP0uUEBjXZ0OQtjYJsKZ
...
CREATE TABLE public.interaction_claims (
    ...
    chain_role character varying(20),
...
CREATE TABLE public.pathways (
    ...
    pathway_type character varying(20) DEFAULT 'main'::character varying NOT NULL,
...
--
-- Name: interactions interaction_type_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.interactions
    ADD CONSTRAINT interaction_type_unique UNIQUE (protein_a_id, protein_b_id, direction, arrow);
...
--
-- Name: idx_claims_pathway_ids_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_claims_pathway_ids_gin ON public.interaction_claims USING gin (pathway_ids);
...
--
-- Name: idx_pathways_depth; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pathways_depth ON public.pathways USING btree (depth);
...
--
-- Name: idx_pathways_normalized_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pathways_normalized_name ON public.pathways USING btree (normalized_name);
...
--
-- Name: uq_claim_fn_null_pw_ctx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_claim_fn_null_pw_ctx ON public.interaction_claims USING btree (interaction_id, function_name, function_context) WHERE (pathway_name IS NULL);


--
-- Name: uq_claim_interaction_fn_pw_ctx_chain; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_claim_interaction_fn_pw_ctx_chain ON public.interaction_claims USING btree (interaction_id, function_name, COALESCE(pathway_name, ''::character varying), COALESCE(function_context, ''::character varying), COALESCE((chain_id)::text, ''::text));


--
-- Name: uq_claim_natural; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_claim_natural ON public.interaction_claims USING btree (interaction_id, function_name, COALESCE(pathway_name, ''::character varying), COALESCE(function_context, ''::character varying), COALESCE(chain_id, 0));


--
-- Name: uq_one_overarching_per_chain; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_one_overarching_per_chain ON public.interaction_claims USING btree (chain_id) WHERE ((is_chain_overarching = true) AND (chain_id IS NOT NULL));
...
\unrestrict vZqc9htGIoXOj3CJcKLSHINSFZT5qotseNQ42p0eRbLyP0uUEBjXZ0OQtjYJsKZ
